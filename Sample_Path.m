...
for I=1:Niter
    [N_fc(I+1),N_fd(I+1),N_fs(I+1), Delta_N]=SMC_only(Timescales,dim,N_fc(I),N_fd(I),N_fs(I),CAPE(I)/CAPE0,CAPEL(I)/CAPE0, DRY(I), CIN(I), Wn(I),DT0,n, stream);
    N_fcs(I+1) = n*n - (N_fc(I+1) + N_fd(I+1) + N_fs(I+1));
    Ntrans(I, :) = Delta_N;
end
